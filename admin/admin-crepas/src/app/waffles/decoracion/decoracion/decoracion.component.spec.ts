...
import { DecoracionesWaffleComponent } from './decoracion.component';
...
describe('DecoracionesWaffleComponent', () => {
  let component: DecoracionesWaffleComponent;
  let fixture: ComponentFixture<DecoracionesWaffleComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ DecoracionesWaffleComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(DecoracionesWaffleComponent);
  ...
  it('should navigate to edit', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editWafflesDecoracion', 2]);
  });
});
