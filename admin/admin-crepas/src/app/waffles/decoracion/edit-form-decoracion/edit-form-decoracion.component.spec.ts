...
import { EditFormDecoracionWaffleComponent } from './edit-form-decoracion.component';
...
describe('EditFormDecoracionWaffleComponent', () => {
  let component: EditFormDecoracionWaffleComponent;
  let fixture: ComponentFixture<EditFormDecoracionWaffleComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormDecoracionWaffleComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormDecoracionWaffleComponent);
