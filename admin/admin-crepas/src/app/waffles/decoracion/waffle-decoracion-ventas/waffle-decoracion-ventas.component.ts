...
@Component({
  selector: 'app-waffle-decoracion-ventas',
  templateUrl: './waffle-decoracion-ventas.component.html',
  styleUrls: ['./waffle-decoracion-ventas.component.css']
})
export class WaffleDecoracionesVentasComponent {
