...
import { WaffleDecoracionesVentasComponent } from './waffle-decoracion-ventas.component';
...
describe('WaffleDecoracionesVentasComponent', () => {
  let component: WaffleDecoracionesVentasComponent;
  let fixture: ComponentFixture<WaffleDecoracionesVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ WaffleDecoracionesVentasComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(WaffleDecoracionesVentasComponent);
