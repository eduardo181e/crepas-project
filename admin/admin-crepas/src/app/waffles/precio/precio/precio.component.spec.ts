...
describe('PrecioComponent', () => {
  ...
  beforeEach(async () => {
    ...
    waflesService = jasmine.createSpyObj('WaflesService', ['getPrecios', 'deletePrecio']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ PrecioComponent, TranslatePipe ],
      providers: [
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createWafflesPrecio']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editWafflesPrecio', 2]);
  });
});
