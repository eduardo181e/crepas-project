...
import { EditFormPrecioComponent } from './edit-form-precio.component';
...
describe('EditFormPrecioComponent', () => {
  let component: EditFormPrecioComponent;
  let fixture: ComponentFixture<EditFormPrecioComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormPrecioComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormPrecioComponent);
