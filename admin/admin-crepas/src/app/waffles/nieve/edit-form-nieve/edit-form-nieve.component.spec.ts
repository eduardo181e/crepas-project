...
import { EditFormNieveComponent } from './edit-form-nieve.component';
...
describe('EditFormNieveComponent', () => {
  let component: EditFormNieveComponent;
  let fixture: ComponentFixture<EditFormNieveComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormNieveComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormNieveComponent);
