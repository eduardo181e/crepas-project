...
import { WafflesNieveStockComponent } from './waffles-nieve-stock.component';
...
describe('WafflesNieveStockComponent', () => {
  let component: WafflesNieveStockComponent;
  let fixture: ComponentFixture<WafflesNieveStockComponent>;
  ...
  beforeEach(async () => {
    ...
    wafflesStockService = jasmine.createSpyObj('WafflesStockService', ['getNieves', 'updateStockNieve']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WafflesNieveStockComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WafflesStockService, useValue: NievesStockServiceMock}
      ]
    })
    .compileComponents();
    ...
    fixture = TestBed.createComponent(WafflesNieveStockComponent);
