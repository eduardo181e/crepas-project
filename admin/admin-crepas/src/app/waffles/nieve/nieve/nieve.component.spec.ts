...
describe('NieveComponent', () => {
  ...
  beforeEach(async () => {
    ...
    waflesService = jasmine.createSpyObj('WaflesService', ['getNieves', 'deleteNieve']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ NieveComponent, TranslatePipe ],
      providers: [
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createWafflesNieve']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editWafflesNieve', 2]);
  });
});
