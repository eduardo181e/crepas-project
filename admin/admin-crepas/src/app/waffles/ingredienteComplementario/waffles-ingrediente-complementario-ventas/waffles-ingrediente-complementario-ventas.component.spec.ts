...
import { WafflesIngredienteComplementarioVentasComponent } from './waffles-ingrediente-complementario-ventas.component';
...
describe('WafflesIngredienteComplementarioVentasComponent', () => {
  let component: WafflesIngredienteComplementarioVentasComponent;
  let fixture: ComponentFixture<WafflesIngredienteComplementarioVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleSalesService = jasmine.createSpyObj('WaffleSalesService', ['getIngredientesComplementarios', 'lapsSalesIngredientesComplementarios']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WafflesIngredienteComplementarioVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleSalesService, useValue: IngredienteComplementarioSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(WafflesIngredienteComplementarioVentasComponent);
