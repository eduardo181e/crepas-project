...
@Component({
  selector: 'app-waffles-ingrediente-complementario-ventas',
  templateUrl: './waffles-ingrediente-complementario-ventas.component.html',
  styleUrls: ['./waffles-ingrediente-complementario-ventas.component.css']
})
export class WafflesIngredienteComplementarioVentasComponent {
