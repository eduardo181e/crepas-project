...
import { CreateFormIngredienteComplementarioComponent } from './create-form-ingrediente-complementario.component';
...
describe('CreateFormIngredienteComplementarioComponent', () => {
  let component: CreateFormIngredienteComplementarioComponent;
  let fixture: ComponentFixture<CreateFormIngredienteComplementarioComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormIngredienteComplementarioComponent, TranslatePipe ],
      providers: [ 
        
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaflesService, useValue: IngredientesComplemetariosServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CreateFormIngredienteComplementarioComponent);
