...
import { IngredienteComplementarioComponent } from './ingrediente-complementario.component';
...
describe('IngredienteComplementarioComponent', () => {
  let component: IngredienteComplementarioComponent;
  let fixture: ComponentFixture<IngredienteComplementarioComponent>;
  ...
  beforeEach(async () => {
    ...
    waflesService = jasmine.createSpyObj('WaflesService', ['getIngredientesC', 'deleteIngredienteC']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ IngredienteComplementarioComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(IngredienteComplementarioComponent);
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createWafflesIngredienteComplementario']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editWafflesIngredienteComplementario', 2]);
  });
});
