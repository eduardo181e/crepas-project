...
@Component({
  selector: 'app-waffles-ingrediente-complementario-stock',
  templateUrl: './waffles-ingrediente-complementario-stock.component.html',
  styleUrls: ['./waffles-ingrediente-complementario-stock.component.css']
})
export class WafflesIngredienteComplementarioStockComponent {
  ingredientes:any;
