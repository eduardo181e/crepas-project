...
import { EditFormIngredienteUntableComponent } from './edit-form-ingrediente-untable.component';
...
describe('EditFormIngredienteUntableComponent', () => {
  let component: EditFormIngredienteUntableComponent;
  let fixture: ComponentFixture<EditFormIngredienteUntableComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormIngredienteUntableComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormIngredienteUntableComponent);
