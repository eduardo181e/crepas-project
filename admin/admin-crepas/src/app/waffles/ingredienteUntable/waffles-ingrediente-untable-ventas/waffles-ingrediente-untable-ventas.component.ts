...
@Component({
  selector: 'app-waffles-ingrediente-untable-ventas',
  templateUrl: './waffles-ingrediente-untable-ventas.component.html',
  styleUrls: ['./waffles-ingrediente-untable-ventas.component.css']
})
export class WafflesIngredienteUntableVentasComponent {
  ...
  constructor(private service: WaffleSalesService, private idService: IdService,private alert: AlertDialogService,private router: Router, private alertService: AlertDialogService, private authService: AuthService) {}
