...
import { WafflesIngredienteUntableVentasComponent } from './waffles-ingrediente-untable-ventas.component';
...
import { WaffleSalesService } from 'src/app/services/sales/waffle-sales.service';

describe('WafflesIngredienteUntableVentasComponent', () => {
  let component: WafflesIngredienteUntableVentasComponent;
  let fixture: ComponentFixture<WafflesIngredienteUntableVentasComponent>;
  let alertService: jasmine.SpyObj<AlertDialogService>;
  let waffleSalesService: jasmine.SpyObj<WaffleSalesService>;
  const mockRouter = jasmine.createSpyObj('Router', ['navigate']);
  const mockIngredienteComplementarioSales = [
    {
      ingrediente_unt: "Café Americano",
      product_id: 1,
      sucursal_id: 1,
      factura_id: 1234,
      ventas: 10,
    ...
    {
      ingrediente_unt: "Chocolate Caliente",
      product_id: 3,
      sucursal_id: 1,
      factura_id: 1236,
      ventas: 8,
    ...
    {
      ingrediente_unt: "Leche de Almendras",
      product_id: 4,
      sucursal_id: 2,
      factura_id: 1237,
      ventas: 3,
    ...
    {
      ingrediente_unt: "Jugo de Naranja",
      product_id: 5,
      sucursal_id: 1,
      factura_id: 1238,
      ventas: 12,
    ...
    {
      ingrediente_unt: "Batido de Fresa",
      product_id: 6,
      sucursal_id: 2,
      factura_id: 1239,
      ventas: 6,
    ...
    {
      ingrediente_unt: "Refresco de Cola",
      product_id: 8,
      sucursal_id: 2,
      factura_id: 1241,
      ventas: 9,
  ...
  const mockIngredienteComplementarioSalesLaps = [
    ...
    {
      ingrediente_unt: "Té de Manzanilla",
      product_id: 11,
      sucursal_id: 1,
      factura_id: 1244,
      ventas: 2,
    ...
    {
      ingrediente_unt: "Smoothie de Frutas",
      product_id: 13,
      sucursal_id: 1,
      factura_id: 1246,
      ventas: 8,
    ...
    {
      ingrediente_unt: "Cacao Caliente",
      product_id: 14,
      sucursal_id: 2,
      factura_id: 1247,
      ventas: 5,
    ...
    {
      ingrediente_unt: "Café con Leche",
      product_id: 15,
      sucursal_id: 1,
      factura_id: 1248,
      ventas: 10,
  ...
  let IngredienteUntableSalesServiceMock = {
    getIngredientesUntables: jasmine.createSpy('getIngredientesUntables').and.returnValue(of(mockIngredienteComplementarioSales)),
    lapsSalesIngredientesUntables: jasmine.createSpy('lapsSalesIngredientesUntables').and.returnValue(of(mockIngredienteComplementarioSalesLaps))
  }
  let AuthServicMock = {
  ...
  beforeEach(async () => {
    ...
    waffleSalesService = jasmine.createSpyObj('WaffleSalesService', ['getIngredientesUntables', 'lapsSalesIngredientesUntables']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WafflesIngredienteUntableVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleSalesService, useValue: IngredienteUntableSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(WafflesIngredienteUntableVentasComponent);
  ...
  it('should give the formatted date', async () => {
    ...
    expect(IngredienteUntableSalesServiceMock.getIngredientesUntables).toHaveBeenCalledWith({fecha:date1, sucursal_id: 1})

    IngredienteUntableSalesServiceMock.getIngredientesUntables.and.returnValue(of(mockIngredienteComplementarioSales))
  });
  ...
  it('should generate sales', async () => {
    ...
    component.genarar();
    await fixture.whenStable();
    expect(IngredienteUntableSalesServiceMock.lapsSalesIngredientesUntables).toHaveBeenCalledWith(ingrediente1)

    IngredienteUntableSalesServiceMock.lapsSalesIngredientesUntables.and.returnValue(of(mockIngredienteComplementarioSalesLaps))
  });
  ...
  it('should show alert and navigate to admin when token expired error occurs', async () => {
    AuthServicMock.lang.and.returnValue('en')
    component.ingrediente1.fecha = new Date()
    IngredienteUntableSalesServiceMock.getIngredientesUntables.and.returnValue(throwError({ error: { message: 'Token expired' } }));
