...
export class BebidasFriasVentasComponent {
  ...
  authService: any = {}
  constructor(private bebidasFriasSalesService: BebidasFriasSalesService, private idService: IdService,private alert: AlertDialogService,private router: Router, private alertService: AlertDialogService, AuthService: AuthService) {
