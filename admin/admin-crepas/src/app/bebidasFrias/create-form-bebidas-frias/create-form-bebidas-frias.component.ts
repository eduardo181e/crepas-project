...
@Component({
  selector: 'app-create-form-bebidas-frias',
  templateUrl: './create-form-bebidas-frias.component.html',
  styleUrls: ['./create-form-bebidas-frias.component.css']
})
export class CreateFormBebidasFriasComponent {
  bebida:any = {
    id: 0,
    bebida: '',
    descripcion: '',
  ...
  saveNewBebida(){        
    ...
    this.bebidasFriasService.saveBebida(this.bebida).subscribe(
      res => {
        console.log(res);
        if(this.authService.lang() === 'es'){
