...
import { CreateFormBebidasFriasComponent } from './create-form-bebidas-frias.component';
...
describe('CreateFormBebidasCalientesComponent', () => {
  let component: CreateFormBebidasFriasComponent;
  let fixture: ComponentFixture<CreateFormBebidasFriasComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormBebidasFriasComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(CreateFormBebidasFriasComponent);
  ...
  it('should send the data correctly', () => {
    ...
    expect(BebidasFriasServiceMock.saveBebida).toHaveBeenCalledWith(bebida)
  });
