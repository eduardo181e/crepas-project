...
import { WaffleCanastaIngredienteComplementarioVentasComponent } from './waffle-canasta-ingrediente-complementario-ventas.component';
...
describe('WaffleCanastaIngredienteComplementarioVentasComponent', () => {
  let component: WaffleCanastaIngredienteComplementarioVentasComponent;
  let fixture: ComponentFixture<WaffleCanastaIngredienteComplementarioVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaSalesService = jasmine.createSpyObj('WaffleCanastaSalesService', ['getIngredientesComplementarios', 'lapsSalesIngredientesComplementarios']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WaffleCanastaIngredienteComplementarioVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaSalesService, useValue: IngredienteComplementarioSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(WaffleCanastaIngredienteComplementarioVentasComponent);
