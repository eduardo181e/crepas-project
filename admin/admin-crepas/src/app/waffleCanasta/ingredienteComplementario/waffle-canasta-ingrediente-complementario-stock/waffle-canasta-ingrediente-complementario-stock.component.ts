...
@Component({
  selector: 'app-waffle-canasta-ingrediente-complementario-stock',
  templateUrl: './waffle-canasta-ingrediente-complementario-stock.component.html',
  styleUrls: ['./waffle-canasta-ingrediente-complementario-stock.component.css']
})
export class WaffleCanastaIngredienteComplementarioStockComponent {
  ingredientes:any;
  sucursal_id:any = this.idService.getId();
  ingrediente1:any = {
    sucursal_id: this.sucursal_id,
  }
    constructor(private stock: WaffleCanastaStockService, private idService: IdService, private alertService: AlertDialogService, private router: Router, private authService: AuthService) { }
