...
import { WaffleCanastaIngredienteComplementarioStockComponent } from './waffle-canasta-ingrediente-complementario-stock.component';
...
describe('WaffleCanastaIngredienteComplementarioStockComponent', () => {
  let component: WaffleCanastaIngredienteComplementarioStockComponent;
  let fixture: ComponentFixture<WaffleCanastaIngredienteComplementarioStockComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaStockService = jasmine.createSpyObj('WaffleCanastaStockService', ['getIngredientesComplementarios', 'updateStockIngredienteComplementario']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WaffleCanastaIngredienteComplementarioStockComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaStockService, useValue: IngredientesStockServiceMock}
      ]
    })
    .compileComponents();
    ...
    fixture = TestBed.createComponent(WaffleCanastaIngredienteComplementarioStockComponent);
