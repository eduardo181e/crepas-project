...
import { WaffleCanastaNievesVentasComponent } from './waffle-canasta-nieves-ventas.component';
...
describe('WaffleCanastaNievesVentasComponent', () => {
  let component: WaffleCanastaNievesVentasComponent;
  let fixture: ComponentFixture<WaffleCanastaNievesVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaSalesService = jasmine.createSpyObj('WaffleCanastaSalesService', ['getNieves', 'lapsSalesNieves']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WaffleCanastaNievesVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaSalesService, useValue: NieveSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(WaffleCanastaNievesVentasComponent);
