...
import { NivesWaffleCanastaComponent } from './nives.component';
...
describe('NivesWaffleCanastaComponent', () => {
  let component: NivesWaffleCanastaComponent;
  let fixture: ComponentFixture<NivesWaffleCanastaComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaService = jasmine.createSpyObj('WaffleCanastaService', ['getNieves', 'deleteNieve']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ NivesWaffleCanastaComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(NivesWaffleCanastaComponent);
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createWafflesCanastaNieve']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editWafflesCanastaNieve', 2]);
  });
});
