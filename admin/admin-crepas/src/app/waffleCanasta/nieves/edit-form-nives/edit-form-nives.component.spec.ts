...
import { EditFormNivesWaffleCanastaComponent } from './edit-form-nives.component';
...
describe('EditFormNivesWaffleCanastaComponent', () => {
  let component: EditFormNivesWaffleCanastaComponent;
  let fixture: ComponentFixture<EditFormNivesWaffleCanastaComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormNivesWaffleCanastaComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormNivesWaffleCanastaComponent);
