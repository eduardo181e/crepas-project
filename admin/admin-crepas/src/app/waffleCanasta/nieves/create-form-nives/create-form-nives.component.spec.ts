...
import { CreateFormNivesWaffleCanastaComponent } from './create-form-nives.component';
...
describe('CreateFormNivesWaffleCanastaComponent', () => {
  let component: CreateFormNivesWaffleCanastaComponent;
  let fixture: ComponentFixture<CreateFormNivesWaffleCanastaComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormNivesWaffleCanastaComponent, TranslatePipe ],
      providers: [ 
        
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaService, useValue: NieveServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CreateFormNivesWaffleCanastaComponent);
