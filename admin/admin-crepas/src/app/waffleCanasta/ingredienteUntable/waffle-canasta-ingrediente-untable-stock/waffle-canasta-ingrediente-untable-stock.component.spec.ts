...
import { WaffleCanastaIngredienteUntableStockComponent } from './waffle-canasta-ingrediente-untable-stock.component';
...
describe('WaffleCanastaIngredienteUntableStockComponent', () => {
  let component: WaffleCanastaIngredienteUntableStockComponent;
  let fixture: ComponentFixture<WaffleCanastaIngredienteUntableStockComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaStockService = jasmine.createSpyObj('WaffleCanastaStockService', ['getIngredientesUntables', 'updateStockIngredienteUntable']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WaffleCanastaIngredienteUntableStockComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(WaffleCanastaIngredienteUntableStockComponent);
