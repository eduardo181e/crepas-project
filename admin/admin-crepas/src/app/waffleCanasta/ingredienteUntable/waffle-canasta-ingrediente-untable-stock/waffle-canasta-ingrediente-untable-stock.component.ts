...
@Component({
  selector: 'app-waffle-canasta-ingrediente-untable-stock',
  templateUrl: './waffle-canasta-ingrediente-untable-stock.component.html',
  styleUrls: ['./waffle-canasta-ingrediente-untable-stock.component.css']
})
export class WaffleCanastaIngredienteUntableStockComponent {
  ingredientes:any;
