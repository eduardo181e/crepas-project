...
import { EditFormIngredientesUntablesWaffleCanastaComponent } from './edit-form-ingredientes-untables.component';
...
describe('EditFormIngredientesUntablesWaffleCanastaComponent', () => {
  let component: EditFormIngredientesUntablesWaffleCanastaComponent;
  let fixture: ComponentFixture<EditFormIngredientesUntablesWaffleCanastaComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormIngredientesUntablesWaffleCanastaComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormIngredientesUntablesWaffleCanastaComponent);
