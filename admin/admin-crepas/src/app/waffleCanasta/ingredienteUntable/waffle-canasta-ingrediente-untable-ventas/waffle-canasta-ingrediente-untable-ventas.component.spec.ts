...
import { WaffleCanastaIngredienteUntableVentasComponent } from './waffle-canasta-ingrediente-untable-ventas.component';
...
describe('WaffleCanastaIngredienteUntableVentasComponent', () => {
  let component: WaffleCanastaIngredienteUntableVentasComponent;
  let fixture: ComponentFixture<WaffleCanastaIngredienteUntableVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    waffleCanastaSalesService = jasmine.createSpyObj('WaffleCanastaSalesService', ['getIngredientesUntables', 'lapsSalesIngredientesUntables']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ WaffleCanastaIngredienteUntableVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaSalesService, useValue: IngredienteUntableSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(WaffleCanastaIngredienteUntableVentasComponent);
