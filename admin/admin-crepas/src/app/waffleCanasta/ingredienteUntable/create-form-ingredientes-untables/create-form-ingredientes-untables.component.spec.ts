...
import { CreateFormIngredientesUntablesWaffleCanastaComponent } from './create-form-ingredientes-untables.component';
...
describe('CreateFormIngredientesUntablesWaffleCanastaComponent', () => {
  let component: CreateFormIngredientesUntablesWaffleCanastaComponent;
  let fixture: ComponentFixture<CreateFormIngredientesUntablesWaffleCanastaComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormIngredientesUntablesWaffleCanastaComponent, TranslatePipe ],
      providers: [ 
        
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: WaffleCanastaService, useValue: IngredientesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CreateFormIngredientesUntablesWaffleCanastaComponent);
