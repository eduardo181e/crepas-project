...
@Component({
  selector: 'app-waffle-canasta-decoracion-stock',
  templateUrl: './waffle-canasta-decoracion-stock.component.html',
  styleUrls: ['./waffle-canasta-decoracion-stock.component.css']
})
export class WaffleCanastadecoracionesStockComponent {
  decoraciones:any;
