...
import { WaffleCanastadecoracionesStockComponent } from './waffle-canasta-decoracion-stock.component';
...
describe('WaffleCanastadecoracionesStockComponent', () => {
  let component: WaffleCanastadecoracionesStockComponent;
  let fixture: ComponentFixture<WaffleCanastadecoracionesStockComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ WaffleCanastadecoracionesStockComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(WaffleCanastadecoracionesStockComponent);
