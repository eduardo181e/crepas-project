...
export class BebidasCalientesVentasComponent {
  ...
  authService: any = {};
  constructor(private bebidasCalientesSalesService: BebidasCalientesSalesService, private idService: IdService,private alert: AlertDialogService,private router: Router, private alertService: AlertDialogService, AuthService: AuthService) {
