...
@Component({
  selector: 'app-waffle-canasta-nieves-ventas',
  templateUrl: './waffle-canasta-nieves-ventas.component.html',
  styleUrls: ['./waffle-canasta-nieves-ventas.component.css']
})
export class WaffleCanastaNievesVentasGlobalesComponent {
