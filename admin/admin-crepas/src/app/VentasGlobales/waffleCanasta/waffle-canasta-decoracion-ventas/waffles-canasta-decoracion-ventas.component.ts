...
@Component({
  selector: 'app-waffles-canasta-decoracion-ventas',
  templateUrl: './waffles-canasta-decoracion-ventas.component.html',
  styleUrls: ['./waffles-canasta-decoracion-ventas.component.css']
})
export class WaffleCanastaDecoracionVentasGlobalesComponent {
