...
@Component({
  selector: 'app-waffle-canasta-ingrediente-complementario-ventas',
  templateUrl: './waffle-canasta-ingrediente-complementario-ventas.component.html',
  styleUrls: ['./waffle-canasta-ingrediente-complementario-ventas.component.css']
})
export class WaffleCanastaIngredienteComplementarioVentasGlobalesComponent {
