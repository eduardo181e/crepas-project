...
@Component({
  selector: 'app-crepa-dulce-decoracion-ventas',
  templateUrl: './crepa-dulce-decoracion-ventas.component.html',
  styleUrls: ['./crepa-dulce-decoracion-ventas.component.css']
})
export class CrepaDulceDecoracionVentasGlobalesComponent {
