...
@Component({
  selector: 'app-waffles-decoracion-decoracion-ventas',
  templateUrl: './waffles-decoracion-ventas.component.html',
  styleUrls: ['./waffles-decoracion-ventas.component.css']
})
export class WaffleDecoracionVentasGlobalesComponent {
