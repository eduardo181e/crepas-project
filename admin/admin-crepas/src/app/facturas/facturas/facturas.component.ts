...
export class FacturasComponent {
  ...
  authService: any = {};
  constructor(private bebidasCalientesSalesService: FacturasService,private alert: AlertDialogService, private router: Router, private alertService: AlertDialogService, AuthService: AuthService) {
  ...
  ngOnInit(): void {
    ...
    this.bebidasCalientesSalesService.allInvoices(this.bebida1).subscribe(
...
res[index].fecha_hora = fechaFormateada;
  ...
  genarar(){
    ...
    this.bebidasCalientesSalesService.lapsAllInvoices(this.bebida1).subscribe(
      (res:any) => {console.log(res)
        res.forEach((element:any , index:any) => {
          const fecha = element.fecha_hora;
          // Separa la fecha en partes
