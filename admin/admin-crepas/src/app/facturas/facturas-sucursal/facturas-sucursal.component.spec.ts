...
import { FacturasSucursalComponent } from './facturas-sucursal.component';
...
describe('FacturasSucursalComponent', () => {
  let component: FacturasSucursalComponent;
  let fixture: ComponentFixture<FacturasSucursalComponent>;
  ...
  let FacturasServiceMock = {
    getInvoices: jasmine.createSpy('getInvoices').and.returnValue(of(pruebas)),
    lapsInvoice: jasmine.createSpy('updateStockBebidaCaliente').and.returnValue(of(pruebas))
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ FacturasSucursalComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(FacturasSucursalComponent);
  ...
  it('should show the invoices', async () => {
    ...
    FacturasServiceMock.getInvoices.and.returnValue(of(pruebas))
    component.ngOnInit()
    await fixture.whenStable();
    expect(FacturasServiceMock.getInvoices).toHaveBeenCalledWith({fecha: date1, sucursal_id: 1})
  });
  ...
  it('should generate sales', async () => {
    ...
    component.genarar();
    await fixture.whenStable();
    expect(FacturasServiceMock.lapsInvoice).toHaveBeenCalledWith(bebida1)

    FacturasServiceMock.lapsInvoice.and.returnValue(of(pruebas))
  });
  ...
  it('should show alert and navigate to admin when token expired error occurs', async () => {
    AuthServicMock.lang.and.returnValue('en')
    component.bebida1.fecha = new Date()
    FacturasServiceMock.getInvoices.and.returnValue(throwError({ error: { message: 'Token expired' } }));
