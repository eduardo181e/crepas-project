...
import { CrepaSaladaIngredienteBaseVentasComponent } from './crepa-salada-ingrediente-base-ventas.component';
...
describe('CrepaDulceIngredienteComplementarioVentasComponent', () => {
  let component: CrepaSaladaIngredienteBaseVentasComponent;
  let fixture: ComponentFixture<CrepaSaladaIngredienteBaseVentasComponent>;
  let alertService: jasmine.SpyObj<AlertDialogService>;
  let crepaSaladaSalesService: jasmine.SpyObj<CrepaSaladaSalesService>;
  const mockRouter = jasmine.createSpyObj('Router', ['navigate']);
  const mockIngredienteSales = [
    {
      ingrediente_base: "Café Americano",
      product_id: 1,
      sucursal_id: 1,
      factura_id: 1234,
      ventas: 10,
    ...
    {
      ingrediente_base: "Chocolate Caliente",
      product_id: 3,
      sucursal_id: 1,
      factura_id: 1236,
      ventas: 8,
    ...
    {
      ingrediente_base: "Leche de Almendras",
      product_id: 4,
      sucursal_id: 2,
      factura_id: 1237,
      ventas: 3,
    ...
    {
      ingrediente_base: "Jugo de Naranja",
      product_id: 5,
      sucursal_id: 1,
      factura_id: 1238,
      ventas: 12,
    ...
    {
      ingrediente_base: "Batido de Fresa",
      product_id: 6,
      sucursal_id: 2,
      factura_id: 1239,
      ventas: 6,
    ...
    {
      ingrediente_base: "Refresco de Cola",
      product_id: 8,
      sucursal_id: 2,
      factura_id: 1241,
      ventas: 9,
  ...
  const mockIngredienteSalesLaps = [
    ...
    {
      ingrediente_base: "Té de Manzanilla",
      product_id: 11,
      sucursal_id: 1,
      factura_id: 1244,
      ventas: 2,
    ...
    {
      ingrediente_base: "Leche de Coco",
      product_id: 12,
      sucursal_id: 2,
      factura_id: 1245,
      ventas: 4,
    ...
    {
      ingrediente_base: "Smoothie de Frutas",
      product_id: 13,
      sucursal_id: 1,
      factura_id: 1246,
      ventas: 8,
    ...
    {
      ingrediente_base: "Cacao Caliente",
      product_id: 14,
      sucursal_id: 2,
      factura_id: 1247,
      ventas: 5,
    ...
    {
      ingrediente_base: "Café con Leche",
      product_id: 15,
      sucursal_id: 1,
      factura_id: 1248,
      ventas: 10,
  ...
  let IngredienteSalesServiceMock = {
    getIngredientesBase: jasmine.createSpy('getIngredientesBase').and.returnValue(of(mockIngredienteSales)),
    lapsSalesIngredientesBase: jasmine.createSpy('lapsSalesIngredientesBase').and.returnValue(of(mockIngredienteSalesLaps))
  }
  let AuthServicMock = {
  ...
  beforeEach(async () => {
    ...
    crepaSaladaSalesService = jasmine.createSpyObj('CrepaSaladaSalesService', ['getIngredientesBase', 'lapsSalesIngredientesBase']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaSaladaIngredienteBaseVentasComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaSaladaIngredienteBaseVentasComponent);
  ...
  it('should give the formatted date', async () => {
    ...
    expect(IngredienteSalesServiceMock.getIngredientesBase).toHaveBeenCalledWith({fecha:date1, sucursal_id: 1})

    IngredienteSalesServiceMock.getIngredientesBase.and.returnValue(of(mockIngredienteSales))
  });
  ...
  it('should generate sales', async () => {
    ...
    component.genarar();
    await fixture.whenStable();
    expect(IngredienteSalesServiceMock.lapsSalesIngredientesBase).toHaveBeenCalledWith(ingrediente1)

    IngredienteSalesServiceMock.lapsSalesIngredientesBase.and.returnValue(of(mockIngredienteSalesLaps))
  });
  ...
  it('should show alert and navigate to admin when token expired error occurs', async () => {
    AuthServicMock.lang.and.returnValue('en')
    component.ingrediente1.fecha = new Date()
    IngredienteSalesServiceMock.getIngredientesBase.and.returnValue(throwError({ error: { message: 'Token expired' } }));
