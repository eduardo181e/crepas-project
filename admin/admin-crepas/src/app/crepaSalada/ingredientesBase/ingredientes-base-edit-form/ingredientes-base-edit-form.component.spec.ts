...
import { IngredientesBaseEditFormComponent } from './ingredientes-base-edit-form.component';
...
describe('IngredientesBaseEditFormComponent', () => {
  let component: IngredientesBaseEditFormComponent;
  let fixture: ComponentFixture<IngredientesBaseEditFormComponent>;
  let alertService: jasmine.SpyObj<AlertDialogService>;
  const mockRouter = jasmine.createSpyObj('Router', ['navigate']);
  let IngredientesServiceMock = {
    getIngredienteB: jasmine.createSpy('getIngredienteB').and.returnValue(of([{ingrediente_base: 'vainilla', inventario: '1', id: 1}])),
    updateIngredienteB: jasmine.createSpy('updateIngredienteB').and.returnValue(of([{ingrediente_base: 'vainilla', inventario: '1', id: 1}])),
  }
  let AuthServicMock = {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ IngredientesBaseEditFormComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(IngredientesBaseEditFormComponent);
  ...
  it('should should return the drink that is going to be edited', () => {
    component.ngOnInit();
    expect(IngredientesServiceMock.getIngredienteB).toHaveBeenCalledWith(123)
    IngredientesServiceMock.getIngredienteB.and.returnValue(of([{ingrediente_base: 'vainilla', inventario: '1', id: 1}]))
    setTimeout(() => { 
      expect(component.ingrediente).toEqual({ingrediente_base: 'vainilla', inventario: '1', id: 1})
    }, 400)
  });
  ...
  it('should send the data correctly', () => {
    ...
    component.updateIngrediente()
    expect(IngredientesServiceMock.updateIngredienteB).toHaveBeenCalledWith(bebida.id, bebida)
    IngredientesServiceMock.updateIngredienteB.and.returnValue(of())
    setTimeout(() => {
  ...
  it('should send the data correctly', () => {
    ...
    component.updateIngrediente()
    expect(IngredientesServiceMock.updateIngredienteB).toHaveBeenCalledWith(bebida.id, bebida)
    IngredientesServiceMock.updateIngredienteB.and.returnValue(throwError({ error: { message: 'Token expired' } }))
    setTimeout(() => {
