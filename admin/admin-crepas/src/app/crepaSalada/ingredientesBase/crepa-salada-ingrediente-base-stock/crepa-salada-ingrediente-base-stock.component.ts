...
@Component({
  selector: 'app-crepa-salada-ingrediente-base-stock',
  templateUrl: './crepa-salada-ingrediente-base-stock.component.html',
  styleUrls: ['./crepa-salada-ingrediente-base-stock.component.css']
})
export class CrepaSaladaIngredienteBaseStockComponent {
  ingredientes:any;
  ...
  authService: any = {};
    ...
    ngOnInit(): void {
      this.stock.getIngredientesBase(this.ingrediente1).subscribe(
        res => {console.log(res)
    ...
    actualizarExistencia(ingrediente:any, id:any){
      if(typeof(ingrediente.existencia) == 'string'){
        ...
        this.stock.updateStockIngredienteBase(id, ingrediente1).subscribe(
          res => {
            this.stock.getIngredientesBase(this.ingrediente1).subscribe(
              res => {
              console.log(res)
