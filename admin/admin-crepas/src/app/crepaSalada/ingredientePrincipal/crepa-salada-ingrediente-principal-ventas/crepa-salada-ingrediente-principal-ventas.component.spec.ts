...
import { CrepaSaladaIngredientePrincipalVentasComponent } from './crepa-salada-ingrediente-principal-ventas.component';
...
describe('CrepaDulceIngredienteComplementarioVentasComponent', () => {
  let component: CrepaSaladaIngredientePrincipalVentasComponent;
  let fixture: ComponentFixture<CrepaSaladaIngredientePrincipalVentasComponent>;
  let alertService: jasmine.SpyObj<AlertDialogService>;
  let crepaSaladaSalesService: jasmine.SpyObj<CrepaSaladaSalesService>;
  const mockRouter = jasmine.createSpyObj('Router', ['navigate']);
  const mockIngredienteSales = [
    {
      ingrediente_pri: "Café Americano",
      product_id: 1,
      sucursal_id: 1,
      factura_id: 1234,
      ventas: 10,
    ...
    {
      ingrediente_pri: "Chocolate Caliente",
      product_id: 3,
      sucursal_id: 1,
      factura_id: 1236,
      ventas: 8,
    ...
    {
      ingrediente_pri: "Leche de Almendras",
      product_id: 4,
      sucursal_id: 2,
      factura_id: 1237,
      ventas: 3,
    ...
    {
      ingrediente_pri: "Jugo de Naranja",
      product_id: 5,
      sucursal_id: 1,
      factura_id: 1238,
      ventas: 12,
    ...
    {
      ingrediente_pri: "Batido de Fresa",
      product_id: 6,
      sucursal_id: 2,
      factura_id: 1239,
      ventas: 6,
    ...
    {
      ingrediente_pri: "Refresco de Cola",
      product_id: 8,
      sucursal_id: 2,
      factura_id: 1241,
      ventas: 9,
  ...
  const mockIngredienteSalesLaps = [
    // ... Bebidas del primer set (10) ...
  
    {
      ingrediente_pri: "Té de Manzanilla",
      product_id: 11,
      sucursal_id: 1,
      factura_id: 1244,
      ventas: 2,
    ...
    {
      ingrediente_pri: "Smoothie de Frutas",
      product_id: 13,
      sucursal_id: 1,
      factura_id: 1246,
      ventas: 8,
    ...
    {
      ingrediente_pri: "Cacao Caliente",
      product_id: 14,
      sucursal_id: 2,
      factura_id: 1247,
      ventas: 5,
    ...
    {
      ingrediente_pri: "Café con Leche",
      product_id: 15,
      sucursal_id: 1,
      factura_id: 1248,
      ventas: 10,
  ...
  let IngredienteSalesServiceMock = {
    getIngredientesPrincipal: jasmine.createSpy('getIngredientesPrincipal').and.returnValue(of(mockIngredienteSales)),
    lapsSalesIngredientesPrincipal: jasmine.createSpy('lapsSalesIngredientesPrincipal').and.returnValue(of(mockIngredienteSalesLaps))
  }
  let AuthServicMock = {
  ...
  beforeEach(async () => {
    ...
    crepaSaladaSalesService = jasmine.createSpyObj('CrepaSaladaSalesService', ['getIngredientesPrincipal', 'lapsSalesIngredientesPrincipal']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaSaladaIngredientePrincipalVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaSaladaSalesService, useValue: IngredienteSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CrepaSaladaIngredientePrincipalVentasComponent);
  ...
  it('should give the formatted date', async () => {
    ...
    expect(IngredienteSalesServiceMock.getIngredientesPrincipal).toHaveBeenCalledWith({fecha:date1, sucursal_id: 1})

    IngredienteSalesServiceMock.getIngredientesPrincipal.and.returnValue(of(mockIngredienteSales))
  });
  ...
  it('should generate sales', async () => {
    ...
    component.genarar();
    await fixture.whenStable();
    expect(IngredienteSalesServiceMock.lapsSalesIngredientesPrincipal).toHaveBeenCalledWith(ingrediente1)

    IngredienteSalesServiceMock.lapsSalesIngredientesPrincipal.and.returnValue(of(mockIngredienteSalesLaps))
  });
  ...
  it('should show alert and navigate to admin when token expired error occurs', async () => {
    AuthServicMock.lang.and.returnValue('en')
    component.ingrediente1.fecha = new Date()
    IngredienteSalesServiceMock.getIngredientesPrincipal.and.returnValue(throwError({ error: { message: 'Token expired' } }));
