...
import { CrepaSaladaPrecioComponent } from './crepa-salada-precio.component';
...
describe('CrepaSaladaPrecioComponent', () => {
  let component: CrepaSaladaPrecioComponent;
  let fixture: ComponentFixture<CrepaSaladaPrecioComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaSaladaService = jasmine.createSpyObj('crepaSaladaService', ['getPrecios', 'deletePrecio']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ CrepaSaladaPrecioComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaSaladaPrecioComponent);
  ...
  it('should return an object without the object with the id that was deleted (error token expired, in return new snows)', async () => {
    await AuthServicMock.lang.and.returnValue('en')
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createCrepaSaladaPrecio']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editCrepaSaladaPrecio', 2]);
  });
});
