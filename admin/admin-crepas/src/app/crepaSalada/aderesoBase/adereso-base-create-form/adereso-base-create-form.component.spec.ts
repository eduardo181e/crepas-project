...
import { AderesoBaseCreateFormComponent } from './adereso-base-create-form.component';
...
describe('AderesoBaseCreateFormComponent', () => {
  let component: AderesoBaseCreateFormComponent;
  let fixture: ComponentFixture<AderesoBaseCreateFormComponent>;
  let alertService: jasmine.SpyObj<AlertDialogService>;
  const mockRouter = jasmine.createSpyObj('Router', ['navigate']);
  let AderesosServiceMock = {
    saveAderesoB: jasmine.createSpy('saveAderesoB').and.returnValue(of([{adereso_base: 'vainilla', inventario: '1', id: 1}])),
  }
  let AuthServicMock = {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ AderesoBaseCreateFormComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(AderesoBaseCreateFormComponent);
  ...
  it('should send the data correctly', () => {
    ...
    component.saveNewAdereso()
    expect(AderesosServiceMock.saveAderesoB).toHaveBeenCalledWith( bebida)
    AderesosServiceMock.saveAderesoB.and.returnValue(of())
    setTimeout(() => {
  ...
  it('should send the data correctly', () => {
    ...
    component.saveNewAdereso()
    expect(AderesosServiceMock.saveAderesoB).toHaveBeenCalledWith(bebida)
    AderesosServiceMock.saveAderesoB.and.returnValue(throwError({ error: { message: 'Token expired' } }))
    setTimeout(() => {
