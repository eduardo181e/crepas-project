...
import { CreateFormCrepaDulceNieveComponent } from './create-form-crepa-dulce-nieve.component';
...
describe('CreateFormCrepaDulceNieveComponent', () => {
  let component: CreateFormCrepaDulceNieveComponent;
  let fixture: ComponentFixture<CreateFormCrepaDulceNieveComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormCrepaDulceNieveComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(CreateFormCrepaDulceNieveComponent);
