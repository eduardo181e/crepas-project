...
import { CrepaDulceNieveVentasComponent } from './crepa-dulce-nieve-ventas.component';
...
describe('CrepaDulceNieveVentasComponent', () => {
  let component: CrepaDulceNieveVentasComponent;
  let fixture: ComponentFixture<CrepaDulceNieveVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceSalesService = jasmine.createSpyObj('CrepaDulceSalesService', ['getNieves', 'lapsSalesNieves']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaDulceNieveVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaDulceSalesService, useValue: NieveSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CrepaDulceNieveVentasComponent);
