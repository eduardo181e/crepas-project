...
import { CrepaDulceIngredientesComplementariosStockComponent } from './crepa-dulce-ingredientes-complementarios-stock.component';
...
describe('CrepaDulceIngredineteComplemetarioStockComponent', () => {
  let component: CrepaDulceIngredientesComplementariosStockComponent;
  let fixture: ComponentFixture<CrepaDulceIngredientesComplementariosStockComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceStockService = jasmine.createSpyObj('CrepaDulceStockService', ['getIngredientesComplementarios', 'updateStockIngredienteComplementario']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaDulceIngredientesComplementariosStockComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaDulceStockService, useValue: IngredientesStockServiceMock}
      ]
    })
    .compileComponents();
    ...
    fixture = TestBed.createComponent(CrepaDulceIngredientesComplementariosStockComponent);
