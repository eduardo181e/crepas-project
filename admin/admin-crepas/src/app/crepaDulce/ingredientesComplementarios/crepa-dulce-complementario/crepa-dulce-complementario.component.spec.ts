...
import { CrepaDulceComplementarioComponent } from './crepa-dulce-complementario.component';
...
describe('CrepaDulceIngredienteComplementarioComponent', () => {
  let component: CrepaDulceComplementarioComponent;
  let fixture: ComponentFixture<CrepaDulceComplementarioComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceService = jasmine.createSpyObj('CrepaDulceService', ['getIngredientesC', 'deleteIngredienteC']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ CrepaDulceComplementarioComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaDulceComplementarioComponent);
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createCrepaDulceComplementario']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editCrepaDulceComplementario', 2]);
  });
});
