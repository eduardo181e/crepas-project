...
import { CreateFormCrepaDulceComplementarioComponent } from './create-form-crepa-dulce-complementario.component';
...
describe('CreateFormCrepaDulceComplementarioComponent', () => {
  let component: CreateFormCrepaDulceComplementarioComponent;
  let fixture: ComponentFixture<CreateFormCrepaDulceComplementarioComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreateFormCrepaDulceComplementarioComponent, TranslatePipe ],
      providers: [ 
        
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaDulceService, useValue: IngredientesComplemetariosServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CreateFormCrepaDulceComplementarioComponent);
