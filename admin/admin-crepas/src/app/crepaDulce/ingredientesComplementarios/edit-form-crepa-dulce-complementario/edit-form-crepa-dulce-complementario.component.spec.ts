...
import { EditFormCrepaDulceComplementarioComponent } from './edit-form-crepa-dulce-complementario.component';
...
describe('EditFormCrepaDulceingredienteComponent', () => {
  let component: EditFormCrepaDulceComplementarioComponent;
  let fixture: ComponentFixture<EditFormCrepaDulceComplementarioComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormCrepaDulceComplementarioComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormCrepaDulceComplementarioComponent);
