...
import { CrepaDulceIngredientesUntablesStockComponent } from './crepa-dulce-ingredientes-untables-stock.component';
...
describe('CrepaDulceIngredineteComplemetarioStockComponent', () => {
  let component: CrepaDulceIngredientesUntablesStockComponent;
  let fixture: ComponentFixture<CrepaDulceIngredientesUntablesStockComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceStockService = jasmine.createSpyObj('CrepaDulceStockService', ['getIngredientesUntables', 'updateStockIngredienteUntable']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaDulceIngredientesUntablesStockComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaDulceIngredientesUntablesStockComponent);
