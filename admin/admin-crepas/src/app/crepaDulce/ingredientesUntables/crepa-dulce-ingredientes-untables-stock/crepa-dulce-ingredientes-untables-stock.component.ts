...
@Component({
  selector: 'app-crepa-dulce-ingredientes-untables-stock',
  templateUrl: './crepa-dulce-ingredientes-untables-stock.component.html',
  styleUrls: ['./crepa-dulce-ingredientes-untables-stock.component.css']
})
export class CrepaDulceIngredientesUntablesStockComponent {
  ingredientes:any;
