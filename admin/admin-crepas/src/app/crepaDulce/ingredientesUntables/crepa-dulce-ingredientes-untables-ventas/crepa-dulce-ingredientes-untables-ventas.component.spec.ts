...
import { CrepaDulceIngredientesUntablesVentasComponent } from './crepa-dulce-ingredientes-untables-ventas.component';
...
describe('CrepaDulceIngredienteComplementarioVentasComponent', () => {
  let component: CrepaDulceIngredientesUntablesVentasComponent;
  let fixture: ComponentFixture<CrepaDulceIngredientesUntablesVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceSalesService = jasmine.createSpyObj('CrepaDulceSalesService', ['getIngredientesUntables', 'lapsSalesIngredientesUntables']);
    await TestBed.configureTestingModule({
      imports: [ HttpClientTestingModule, FormsModule],
      declarations: [ CrepaDulceIngredientesUntablesVentasComponent, TranslatePipe ],
      providers: [
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaDulceSalesService, useValue: IngredienteUntableSalesServiceMock},
        { provide: AuthService, useValue: AuthServicMock},
      ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(CrepaDulceIngredientesUntablesVentasComponent);
