...
import { CrepaDulceUntableComponent } from './crepa-dulce-untable.component';
...
describe('CrepaDulceIngredienteComplementarioComponent', () => {
  let component: CrepaDulceUntableComponent;
  let fixture: ComponentFixture<CrepaDulceUntableComponent>;
  ...
  beforeEach(async () => {
    ...
    crepaDulceService = jasmine.createSpyObj('CrepaDulceService', ['getIngredientesU', 'deleteIngredienteU']);
    await TestBed.configureTestingModule({
      imports: [ FormsModule, HttpClientTestingModule ],
      declarations: [ CrepaDulceUntableComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaDulceUntableComponent);
  ...
  it('should navigate to create', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['createCrepaDulceUntable']);
  });

  it('should navigate to edit', () => {
    component.navigateEdit(2)
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editCrepaDulceUntable', 2]);
  });
});
