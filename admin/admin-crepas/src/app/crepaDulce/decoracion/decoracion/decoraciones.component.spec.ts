...
import { DecoracionesCrepaDulceComponent } from './decoraciones.component';
...
describe('DecoracionesCrepaDulceComponent', () => {
  let component: DecoracionesCrepaDulceComponent;
  let fixture: ComponentFixture<DecoracionesCrepaDulceComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ DecoracionesCrepaDulceComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(DecoracionesCrepaDulceComponent);
  ...
  it('should navigate to edit', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['editCreapaDulceCanastaDecoracion', 2]);
  });
});
