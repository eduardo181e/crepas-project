...
import { CrepaDulceDecoracionesVentasComponent } from './crepa-dulce-decoracion-ventas.component';
...
describe('CrepaDulceDecoracionesVentasComponent', () => {
  let component: CrepaDulceDecoracionesVentasComponent;
  let fixture: ComponentFixture<CrepaDulceDecoracionesVentasComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CrepaDulceDecoracionesVentasComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CrepaDulceDecoracionesVentasComponent);
