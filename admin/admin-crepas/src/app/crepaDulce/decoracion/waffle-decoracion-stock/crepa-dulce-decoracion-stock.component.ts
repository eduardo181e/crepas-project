...
@Component({
  selector: 'app-crepa-dulce-decoracion-stock',
  templateUrl: './crepa-dulce-decoracion-stock.component.html',
  styleUrls: ['./crepa-dulce-decoracion-stock.component.css']
})
export class CreapaDulceDecoracionesStockComponent {
  decoraciones:any;
  sucursal_id:any = this.idService.getId();
  bebida1:any = {
    sucursal_id: this.sucursal_id,
  }
  constructor(private stock: CrepaDulceStockService, private idService: IdService, private router: Router, private alertService: AlertDialogService, private authService: AuthService) { }
