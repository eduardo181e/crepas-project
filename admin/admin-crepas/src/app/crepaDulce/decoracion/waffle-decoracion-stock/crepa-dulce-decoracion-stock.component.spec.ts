...
import { CreapaDulceDecoracionesStockComponent } from './crepa-dulce-decoracion-stock.component';
...
describe('CreapaDulceDecoracionesStockComponent', () => {
  let component: CreapaDulceDecoracionesStockComponent;
  let fixture: ComponentFixture<CreapaDulceDecoracionesStockComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ CreapaDulceDecoracionesStockComponent, TranslatePipe ],
      providers: [
    ...
    fixture = TestBed.createComponent(CreapaDulceDecoracionesStockComponent);
