...
import { EditFormDecoracionCrepaDulceComponent } from './edit-form-decoracion.component';
...
describe('EditFormDecoracionCrepaDulceComponent', () => {
  let component: EditFormDecoracionCrepaDulceComponent;
  let fixture: ComponentFixture<EditFormDecoracionCrepaDulceComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormDecoracionCrepaDulceComponent, TranslatePipe ],
      providers: [ 
    ...
    fixture = TestBed.createComponent(EditFormDecoracionCrepaDulceComponent);
