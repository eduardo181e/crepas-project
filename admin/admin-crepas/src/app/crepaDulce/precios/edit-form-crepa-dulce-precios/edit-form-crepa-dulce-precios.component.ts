...
@Component({
  selector: 'app-edit-form-crepa-dulce-precios',
  templateUrl: './edit-form-crepa-dulce-precios.component.html',
  styleUrls: ['./edit-form-crepa-dulce-precios.component.css']
})
export class EditFormCrepaDulcePreciosComponent {
  precio1: any = [];
