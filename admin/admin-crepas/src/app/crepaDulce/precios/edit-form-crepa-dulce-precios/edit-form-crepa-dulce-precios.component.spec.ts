...
import { EditFormCrepaDulcePreciosComponent } from './edit-form-crepa-dulce-precios.component';
...
describe('EditFormCrepaDulcePreciosComponent', () => {
  let component: EditFormCrepaDulcePreciosComponent;
  let fixture: ComponentFixture<EditFormCrepaDulcePreciosComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ EditFormCrepaDulcePreciosComponent, TranslatePipe ],
      providers: [ 
        { provide: AlertDialogService, useValue: alertService },
        { provide: Router, useValue: mockRouter },
        { provide: CrepaDulceService, useValue: PrecioServiceMock},
    ...
    fixture = TestBed.createComponent(EditFormCrepaDulcePreciosComponent);
