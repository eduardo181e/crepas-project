        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM bfv WHERE DATE(created_at) = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM bfv WHERE DATE(created_at) BETWEEN ? AND ? AND adminId = ?';
...
exports.default = bebidasFriasVentasController;
