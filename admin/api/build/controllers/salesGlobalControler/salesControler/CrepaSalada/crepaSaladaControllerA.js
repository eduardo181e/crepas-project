        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                if (fullname === models_1.admin) {
                    ...
                    const query = 'SELECT * FROM csav WHERE DATE(created_at) = ? AND sucursal_id = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                if (fullname === models_1.admin) {
                    ...
                    const query = 'SELECT * FROM csav WHERE DATE(created_at) BETWEEN ? AND ? AND sucursal_id = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                if (fullname === models_1.admin) {
                    ...
                    const query = 'SELECT * FROM csav WHERE id = ?';
