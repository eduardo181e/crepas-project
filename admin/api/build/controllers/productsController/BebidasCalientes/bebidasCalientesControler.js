                ...
                try {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales WHERE adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO bce SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM bce WHERE product_id = ? AND adminId = ?', [bebidaId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (parseInt(bebida.inventario) === bebidas[0].inventario) {
                        ...
                        yield database_1.default.promise().query('UPDATE bce SET ? WHERE product_id = ? AND adminId = ?', [{ bebida: bebida.bebida, descripcion: bebida.descripcion }, bebidaId, adminId])
                            .then(() => {
                        ...
                        // Actualizar registros de ventas y existencias
                        yield database_1.default.promise().query('UPDATE bce SET ? WHERE product_id = ? AND adminId = ?', [{ bebida: bebida.bebida, descripcion: bebida.descripcion, cantidad: bebidax.cantidad, existencia: bebidax.existencia, inventario: bebidax.inventario }, bebidaId, adminId])
                            .then(() => {
                            console.log('Registro de existencias actualizado');
                        })
                            .catch(err => {
