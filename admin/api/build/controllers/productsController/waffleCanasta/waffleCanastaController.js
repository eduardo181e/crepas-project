        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM wcp WHERE id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO wcp SET ?', [precio])
                        .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'DELETE FROM wcp WHERE id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'UPDATE wcp SET ? WHERE id = ? AND adminId = ?';
...
exports.default = waflesCanastaController;
