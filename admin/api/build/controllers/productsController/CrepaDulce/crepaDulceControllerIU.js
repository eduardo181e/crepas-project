...
class CrepaDulceIngredienteUntableController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdiu WHERE adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdiu WHERE id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO cdiu SET ?', { ingrediente_unt: ingrediente, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales WHERE adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO cdiue SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'DELETE FROM cdiu WHERE id = ? AND adminId = ?';
                    ...
                    yield database_1.default.promise().query('DELETE FROM cdiue WHERE product_id = ? AND adminId = ?', [ingredienteId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (ingredientes[0].inventario === parseInt(inventario)) {
                        const query = 'UPDATE cdiu SET ? WHERE id = ? AND  adminId = ?';
                        ...
                        yield database_1.default.promise().query('UPDATE cdiue SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_unt: req.body.ingrediente_unt }, ingredienteId, adminId])
                            .then(() => {
                        ...
                        // Update ingredientes untables ventas y existencias
                        yield database_1.default.promise().query('UPDATE cdiue SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_unt: req.body.ingrediente_unt, cantidad: inventario, inventario: 0, existencia: 0 }, ingredienteId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
...
const crepaDulceIUController = new CrepaDulceIngredienteUntableController();
exports.default = crepaDulceIUController;
