...
class CrepaDulcenieveController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdn WHERE adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdn WHERE id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO cdn SET ?', { nieve: nieve, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales WHERE adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO cdne SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const adminId = decodedToken.id;
                    const nieveId = req.params.id;
                    const query = 'DELETE FROM cdn WHERE id = ? AND adminId = ?';
                    ...
                    yield database_1.default.promise().query('DELETE FROM cdne WHERE product_id = ? AND adminId', [nieveId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (nieves[0].inventario === parseInt(inventario)) {
                        const query = 'UPDATE cdn SET ? WHERE id = ? AND adminId = ?';
                        ...
                        yield database_1.default.promise().query('UPDATE cdne SET ? WHERE product_id = ? AND adminId = ?', [{ nieve: req.body.nieve }, nieveId, adminId])
                            .then(() => {
                        ...
                        // Actualizar registros de venas y existencias de nieves
                        yield database_1.default.promise().query('UPDATE cdne SET ? WHERE product_id = ? AND adminId = ?', [{ nieve: req.body.nieve, cantidad: inventario, inventario: 0, existencia: 0 }, nieveId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
...
const crepaDulceNController = new CrepaDulcenieveController();
exports.default = crepaDulceNController;
