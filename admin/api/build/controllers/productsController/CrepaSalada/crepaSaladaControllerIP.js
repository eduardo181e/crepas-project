        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO csip SET ?', { ingrediente_pri: ingrediente_pri, inventario: req.body.inventario, adminId: adminId })
                        .then((resutlt) => {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales WHERE adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO csipe SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM csipe WHERE product_id = ? AND adminId = ?', [ingredienteId, adminId])
                        .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM csip WHERE id = ? AND adminId = ?';
                    const ingrediente = yield database_1.default.promise().query(query, [ingredienteId, adminId])
                    ...
                    if (ingrediente[0].inventario === parseInt(inventario)) {
                        ...
                        yield database_1.default.promise().query(query, [{ ingrediente_pri: req.body.ingrediente_pri.trim() }, ingredienteId, adminId])
                            .then(() => {
                        ...
                        yield database_1.default.promise().query('UPDATE csipe SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_pri: req.body.ingrediente_pri.trim() }, ingredienteId, adminId])
                            .then(() => {
                        ...
                        const query = 'UPDATE csip SET ? WHERE id = ? AND adminId = ?';
                        yield database_1.default.promise().query(query, [{ ingrediente_pri: req.body.ingrediente_pri.trim(), inventario: parseInt(inventario) }, ingredienteId, adminId])
                            .then(() => {
                            res.json({ message: 'Ingrediente actualizado' });
                        })
                            .catch(err => {
                        ...
                        // Actualizar registro de existencias y ventas
                        yield database_1.default.promise().query('UPDATE csipe SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_pri: req.body.ingrediente_pri.trim(), cantidad: parseInt(inventario), inventario: 0, existencia: 0 }, ingredienteId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
