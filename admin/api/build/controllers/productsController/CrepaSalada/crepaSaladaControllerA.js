        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO csa SET ?', { adereso: adereso, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales AND adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO csae SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM csae WHERE product_id = ? AND adminId = ?', [aderesoId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (parseInt(inventario) === aderesos[0].inventario) {
                        ...
                        yield database_1.default.promise().query(query, [{ adereso: req.body.adereso.trim() }, aderesoId, adminId])
                            .then(() => {
                        ...
                        yield database_1.default.promise().query('UPDATE csae SET ? WHERE product_id = ? AND adminId = ?', [{ adereso: req.body.adereso.trim() }, aderesoId, adminId])
                            .then(() => {
                        ...
                        const query = 'UPDATE csa SET ? WHERE id = ? AND adminId = ?';
                        yield database_1.default.promise().query(query, [{ adereso: req.body.adereso.trim(), inventario: parseInt(inventario) }, aderesoId, adminId])
                            .then(() => {
                            res.json({ message: 'adereso actualizado' });
                        })
                            .catch(err => {
                        ...
                        // Update adereso ventas y existencias
                        yield database_1.default.promise().query('UPDATE csae SET ? WHERE product_id = ? AND adminId = ?', [{ adereso: req.body.adereso.trim(), cantidad: parseInt(inventario), inventario: 0, existencia: 0 }, aderesoId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
...
exports.default = crepaSaladaAController;
