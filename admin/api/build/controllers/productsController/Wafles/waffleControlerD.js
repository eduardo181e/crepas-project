        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM wd WHERE adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM wd WHERE id = ? AND adminId = ?';
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (decoraciones[0].inventario === parseInt(inventario)) {
                        const query = 'UPDATE wd SET ? WHERE id = ? AND adminId = ?';
                        ...
                        yield database_1.default.promise().query('UPDATE wde SET ? WHERE product_id = ? AND adminId = ?', [{ decoracion: req.body.decoracion }, decoracionId, adminId])
                            .then(() => {
                        ...
                        // Actualizar registros de venas y existencias de decoraciones
                        yield database_1.default.promise().query('UPDATE wde SET ? WHERE product_id = ? AND adminId = ?', [{ decoracion: req.body.decoracion, cantidad: inventario, inventario: 0, existencia: 0 }, decoracionId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
