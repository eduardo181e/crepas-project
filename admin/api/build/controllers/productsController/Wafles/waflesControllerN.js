        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO wn SET ?', { nieve: nieve, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM wne WHERE product_id = ? AND adminId', [nieveId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (nieves[0].inventario === parseInt(inventario)) {
                        ...
                        yield database_1.default.promise().query('UPDATE wne SET ? WHERE product_id = ? AND adminId = ?', [{ nieve: req.body.nieve }, nieveId, adminId])
                            .then(() => {
                        ...
                        // Actualizar registros de venas y existencias de nieves
                        yield database_1.default.promise().query('UPDATE wne SET ? WHERE product_id = ? AND adminId = ?', [{ nieve: req.body.nieve, cantidad: inventario, inventario: 0, existencia: 0 }, nieveId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
