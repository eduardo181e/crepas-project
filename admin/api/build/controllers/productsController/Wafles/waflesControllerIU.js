        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO wiu SET ?', { ingrediente_unt: ingrediente, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM wiue WHERE product_id = ? AND adminId = ?', [ingredienteId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (ingredientes[0].inventario === parseInt(inventario)) {
                        ...
                        yield database_1.default.promise().query('UPDATE wiue SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_unt: req.body.ingrediente_unt }, ingredienteId, adminId])
                            .then(() => {
                        ...
                        // Update ingredientes untables ventas y existencias
                        yield database_1.default.promise().query('UPDATE wiue SET ? WHERE product_id = ? AND adminId = ?', [{ ingrediente_unt: req.body.ingrediente_unt, cantidad: inventario, inventario: 0, existencia: 0 }, ingredienteId, adminId])
                            .then(() => {
                            console.log('registro de existencias actualizado');
                        })
                            .catch(err => {
