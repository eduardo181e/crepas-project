        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM wp WHERE adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM wp WHERE id = ? AND adminId = ?';
                    const precios = yield database_1.default.promise().query(query, [precioId, adminId])
                        .then(precios => precios[0])
                        .catch(err => console.log(err));
                    if (precios.length > 0) {
                        res.json(precios);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO wp SET ?', [precio])
                        .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'DELETE FROM wp WHERE id = ? AND adminId = ?';
                    yield database_1.default.promise().query(query, [precioId, adminId])
                        .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'UPDATE wp SET ? WHERE id = ? AND adminId = ?';
                    yield database_1.default.promise().query(query, [precio, precioId, adminId])
                        .then(() => {
...
const waflesPController = new waflesPreciosController();
exports.default = waflesPController;
