...
class CrepaSaladaBotanaExistenciasController {
    list(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const bebidas = yield database_1.default.promise().query(query, [botanaId, sucursalId, adminId])
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (cantidad === 0) {
                        const sucursalId = req.body.sucursal_id;
                        const botanaId = req.params.id;
                        const updateBotana = req.body.existencia;
                        yield database_1.default.promise().query('UPDATE csbe SET existencia = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateBotana, botanaId, sucursalId, adminId])
                        ...
                        yield database_1.default.promise().query('UPDATE csbe SET existencia = ?, inventario = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateBotana, inventario, botanaId, sucursalId, adminId])
                            .then(() => res.json({ message: 'El stock fue actualizado' }))
                            .catch(err => res.json({ 'Error al actualizar el stock:': err }));
                    }
                }
...
const crepaSaladaBEController = new CrepaSaladaBotanaExistenciasController();
exports.default = crepaSaladaBEController;
