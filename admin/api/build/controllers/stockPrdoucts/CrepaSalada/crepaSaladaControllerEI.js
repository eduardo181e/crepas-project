        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const bebidas = yield database_1.default.promise().query(query, [ensaladaId, sucursalId, adminId])
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (cantidad === 0) {
                        ...
                        yield database_1.default.promise().query('UPDATE cseie SET existencia = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateEnsalada, ensaladaId, sucursalId, adminId])
                        ...
                        yield database_1.default.promise().query('UPDATE cseie SET existencia = ?, inventario = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateEnsalada, inventario, ensaladaId, sucursalId, adminId])
                            .then(() => res.json({ message: 'El stock fue actualizado' }))
                            .catch(err => res.json({ 'Error al actualizar el stock:': err }));
                    }
                }
...
exports.default = crepaSaladaEIEController;
