...
class CrepaSaladaAderesoBaseExistenciasController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM csabe WHERE sucursal_id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const bebidas = yield database_1.default.promise().query(query, [aderesoId, sucursalId, adminId])
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (cantidad === 0) {
                        const sucursalId = req.body.sucursal_id;
                        const aderesoId = req.params.id;
                        const updateAdereso = req.body.existencia;
                        yield database_1.default.promise().query('UPDATE csabe SET existencia = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateAdereso, aderesoId, sucursalId, adminId])
                        ...
                        yield database_1.default.promise().query('UPDATE csabe SET existencia = ?, inventario = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateAdereso, inventario, aderesoId, sucursalId, adminId])
                            .then(() => res.json({ message: 'El stock fue actualizado' }))
                            .catch(err => res.json({ 'Error al actualizar el stock:': err }));
                    }
                    else if (cantidad === 1) {
...
const crepaSaladaABEController = new CrepaSaladaAderesoBaseExistenciasController();
exports.default = crepaSaladaABEController;
