...
class AuthenticationRoutes {
    ...
    config() {
        ...
        this.router.post('/changePassword', authenticationController_1.default.changePassword);
        this.router.post('/changeUsername', authenticationController_1.default.changeUsername);
