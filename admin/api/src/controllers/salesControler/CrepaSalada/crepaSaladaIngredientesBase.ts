    ...
    public async list(req: Request, res: Response): Promise<void> {
      if(req.headers['authorization'] === undefined){
          ...
          const adminId = decodedToken.id
            ...
            const query = 'SELECT * FROM csibv WHERE DATE(created_at) = ? AND sucursal_id = ? AND adminId = ?';
    ...
    public async listLaps(req: Request, res: Response): Promise<void> {
        if(req.headers['authorization'] === undefined){
            ...
            const adminId = decodedToken.id
              ...
              const query = 'SELECT * FROM csibv WHERE DATE(created_at) BETWEEN ? AND ? AND sucursal_id = ? AND adminId = ?';
...
export default crepaSaladaIBVController;