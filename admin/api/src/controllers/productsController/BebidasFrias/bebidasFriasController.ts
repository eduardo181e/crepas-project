  ...
  public async list(req: Request, res: Response): Promise<void> {
    ...
    public async create(req: Request, res: Response): Promise<void> {
      ...
      .then((sucursales:any) => {
        sucursales[0].forEach(async (sucursal:any) => {
          ...
          await pool.promise().query('INSERT INTO bfe SET ?', [registro])
          .then(() => {
    ...
    public async delete(req: Request, res: Response){
        ...
        await pool.promise().query(query, [bebidaId, adminId])
          ...
          await pool.promise().query('DELETE FROM bfe WHERE product_id = ? AND adminId = ?', [bebidaId, adminId])
          .then(() => {
    ...
    public async update(req: Request, res: Response){
        ...
        await pool.promise().query(query, [bebida, bebidaId, adminId])
          ...
          await pool.promise().query('UPDATE bfe SET ? WHERE product_id = ? AND adminId = ?', [{bebida: bebida.bebida, descripcion: bebida.descripcion}, bebidaId, adminId])
          .then(() => {
          ...
          await pool.promise().query(query, [bebida, bebidaId, adminId])
              ...
              // Actualizar registros de ventas y existencias
              await pool.promise().query('UPDATE bfe SET ? WHERE product_id = ? AND adminId = ?', [{bebida: bebida.bebida, descripcion: bebida.descripcion, cantidad: bebidax.cantidad, existencia: bebidax.existencia, inventario: bebidax.inventario}, bebidaId, adminId])
              .then(() => {
                console.log('Registro de existencias actualizado');
              })
              .catch(err => {
