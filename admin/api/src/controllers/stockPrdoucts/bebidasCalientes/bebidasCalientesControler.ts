...
class BebidasCalientesExistenciasController {
    ...
    public async update(req: Request, res: Response){
        ...
        await pool.promise().query('UPDATE bce SET existencia = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateBebida, bebidaId, sucursalId, adminId])
        .then( updtae => {
            console.log(updtae)
        ...
        console.log(bebidaId)
        console.log(sucursalId)
        await pool.promise().query('UPDATE bce SET existencia = ?, inventario = ? WHERE product_id = ? AND sucursal_id = ? AND adminId = ?', [updateBebida, inventario, bebidaId, sucursalId, adminId])
        .then( updtae => {
            console.log(updtae)
            res.json({message: 'El stock fue actualizado'})
        })
...
export default bebidasCalientesExistenciasController;