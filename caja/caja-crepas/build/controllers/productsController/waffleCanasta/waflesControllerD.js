...
class WaflesCanastadecoracionController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const decoracion2 = yield database_1.default.promise().query('SELECT * FROM wcd WHERE adminId = ?', [adminId])
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const query = 'SELECT * FROM wcd WHERE id = ?';
...
const waflesCanastaDController = new WaflesCanastadecoracionController();
exports.default = waflesCanastaDController;
