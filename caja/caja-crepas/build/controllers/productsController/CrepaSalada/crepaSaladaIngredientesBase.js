...
class CrepaSaladaIngredienteBaseController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ingredientes2 = yield database_1.default.promise().query('SELECT * FROM csib WHERE adminId = ?', [adminId])
                ...
                const resultado = ingredientes2.map((ingrediente) => {
                    ...
                    return {
                        ...
                        ingrediente_base: ingrediente.ingrediente_base,
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const query = 'SELECT * FROM csib WHERE id = ?';
