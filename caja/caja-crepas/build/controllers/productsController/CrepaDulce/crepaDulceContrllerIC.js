...
class CrepaDulceIngredienteComplementarioController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ingredientes2 = yield database_1.default.promise().query('SELECT * FROM cdic WHERE adminId = ?', [adminId])
    ...
    sales(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            complementos.forEach((element) => __awaiter(this, void 0, void 0, function* () {
                const sale = {
